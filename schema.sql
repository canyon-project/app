...
-- CreateTable
CREATE TABLE "canyon_next_coverage" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "canyon_next_coverage_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "canyon_next_coverage_map_relation" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "canyon_next_coverage_map_relation_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "canyon_next_coverage_map" (
    "hash" TEXT NOT NULL,
    "map" BYTEA NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "canyon_next_coverage_map_pkey" PRIMARY KEY ("hash")
);

-- CreateTable
CREATE TABLE "canyon_next_coverage_source_map" (
    "hash" TEXT NOT NULL,
    "source_map" BYTEA NOT NULL,

    CONSTRAINT "canyon_next_coverage_source_map_pkey" PRIMARY KEY ("hash")
);
...
-- CreateTable
CREATE TABLE "canyon_next_coverage_lock" (
    "coverage_id" TEXT NOT NULL,
    "locked_at" TIMESTAMP(3) NOT NULL,
    "locked_by" TEXT NOT NULL,

    CONSTRAINT "canyon_next_coverage_lock_pkey" PRIMARY KEY ("coverage_id")
);
